...
export default function EstoqueSeco() {
  ...
  const { historico, addHistoricoItem } = useEstoqueSecoHistorico();
  ...
  const categorias = ['todas', 'Grãos', 'Cereais', 'Temperos', 'Enlatados', 'Bebidas', 'Doces', 'Outros'];
    ...
    <div className="container mx-auto p-2 sm:p-4 md:p-6 space-y-4 sm:space-y-6">
      <div className="flex items-center gap-3 mb-4 sm:mb-6">
        <div className="p-2 bg-amber-100 rounded-lg">
          <Plus className="h-4 w-4 sm:h-6 sm:w-6 text-amber-600" />
        </div>
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">Estoque Seco</h1>
      </div>
        ...
        <div className="flex flex-wrap gap-2">
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            <DialogTrigger asChild>
              <Button className="bg-amber-500 hover:bg-amber-600 text-white shadow-lg text-xs sm:text-sm">
